...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="{{ route('frontend.partenaire.telechargement') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <nav class="navbar navbar-main navbar-expand-lg d-sm-none px-0 mx-4 shadow-none border-radius-xl"
            id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">Téléchargements</h6>
                </nav>
        ...
        @endif --}}
            ...
            <!-- formulaire -->
            <div class="col-12">
                <form action="{{ route('videos.store_partenaire') }}" class="form" method="post" id="formvideo"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="runtime" class="form__input"
                                        placeholder="Durée en minutes" value="{{ old('runtime') }}">
                                </div>

                                <div class="col-12 col-sm-6">
                                    <input type="text" name="year" class="form__input"
                                        placeholder="Année de sortie" value="{{ old('year') }}">
                                </div>

                                <div class="col-12">
                                    <h5 style="color: #000">Sélectionner la catégorie</h5>
                                    <select class="form__input" id="genreSelect" name="genres[]">
                                        ...
                                        <option value="aventure" {{ old('genres') == 'aventure' ? 'selected' : '' }}>
                                            Aventure</option>
                                        <option value="mystere" {{ old('genres') == 'serie_mystere' ? 'selected' : '' }}>
                                            Mystère</option>
                                    </select>
                                </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="directors[]" id="directorsHiddenInput"
                                            value="">
                                        <!-- Changer l'identifiant -->
                                    </div>
                                    <div class="row">
                            ...
                            <div class="col-12">
                                <b>
                                    <h6 style="color: #000;">Image de couverture</h6>
                                </b>
                            ...
                            <div class="col-12 mt-3 mb-3">
                                <b>
                                    <h6 style="color: #000;">Télécharger la demo </h6>
                                </b>
                            ...
                            <div class="col-12 mt-3 mb-3">
                                <b>
                                    <h6 style="color: #000;">Télécharger une vidéo </h6>
                                </b>
                    ...
                    <div class="col-12">
                        <button type="submit" class="form__btn" id="uploadButton">Envoyer</button>
                    </div>
            </div>
            </form>
        ...
        <script>
            ...
            document.getElementById('addRealisaButton').addEventListener('click', function(e) {
                e.preventDefault(); // Empêche le rechargement de la page

                var directorInput = document.getElementById('directorInput');
                var directorList = document.getElementById('directorList');
                var directorsHiddenInput = document.getElementById('directorsHiddenInput');
            ...
            // Met à jour l'input masqué des réalisateurs
            ...
            // Ajouter un acteur
            document.getElementById('addActorButton').addEventListener('click', function(e) {
                e.preventDefault();

                var actorInput = document.getElementById('actorInput');
            ...
            // Met à jour l'input masqué des acteurs
