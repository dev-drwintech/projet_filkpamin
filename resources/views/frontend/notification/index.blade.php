...
@section('content')
    <!-- page title -->
    <section class="section section--first section--bg m-0" data-bg="{{ asset('img/section/section.jpg') }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section__wrap">
                        ...
                        <!-- breadcrumb -->
                        <ul class="breadcrumb">
                            <li class="breadcrumb__item"><a href="{{ route('home') }}">Acceuil</a></li>
            ...
            <div class="row">
                            ...
                            @forelse($notifications as $notification)
                                <div class="d-md-flex align-items-center list-group-item list-group-item-action"
                                    ...
                                    <h4 class="notifications ml-md-2">
                                        ...
                                        commentaire {{ str_replace('@'.auth()->user()->name, "", $notification->data['comment_comment_text']) }}
                ...
                <div class="col-12">
                    <div class="paginator-wrap">
                        ...
                        @endif
                        {{ $notifications->links('pagination-bulma::bulma') }}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
