                    ...
                    <div class="row">
                        <div class="col-12 col-md-7 form__content">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <label for="commentText" class="profile__label">Commentaire</label>
                                    <textarea id="commentText" name="comment_text" class="form__textarea" placeholder="Écrivez votre commentaire..."
