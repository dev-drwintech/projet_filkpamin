                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-12">
                                <form action="{{ route('users.update', $user->id) }}" class="profile__form" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h4 class="profile__title">Détails du profil</h4>
                                        </div>

                                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                            <div class="profile__group">
                                                <label class="profile__label" for="email">Email</label>
                                                <input id="email" type="text" name="email" class="profile__input" value="{{ $user->email }}" >
                                            </div>
                                        </div>

                                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                            <div class="profile__group">
                                                <label class="profile__label" for="name">Nom</label>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                            <div class="profile__group">
                                                <label class="profile__label" for="rights">Rôle</label>
                                                <select class="js-example-basic-single" id="rights" name="role">
                                                    <option value="{{ $user->role->id }}">{{ $user->role->nom }}</option>
                                                    @foreach ($roles as $role)
                                                    @if ($role->nom != $user->role->nom)
