...
class VideoController extends Controller
{
    ...
    {
        $query = Video::where('status', 1)->select('id', 'slug', 'description', 'title', 'views', 'type', 'genres', 'poster');
    ...
    {
        // TODO: add select on videoLike and videoDislike query
        ...
        $videos = Video::select('id', 'slug', 'title', 'type','video', 'genres','runtime', 'poster','photos', 'views')->take(20)->get();
